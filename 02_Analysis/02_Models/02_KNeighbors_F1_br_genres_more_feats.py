...
Usage:
    ...
    3. Run the script: python 02_KNeighbors_F1_br_genres_more_feats.py

Notes:
    - Adjust paths and filenames as needed.
    - Results are saved to 'kneighbors_results_F1_br_genres_more_feats.csv' in the specified output directory.
"""
...
df_results_KNN = analysis_functions.exec_model(train_and_evaluate_knn, df, br_genres, feat_group_model, "KNeighbors", False)

# Combine results and save to CSV
df_results_KNN.to_csv(f'{folder_output}/kneighbors_results_F1_br_genres_more_feats.csv', index=False)
logger.success(f"Results saved to '{folder_output}/kneighbors_results_F1_br_genres_more_feats.csv'")
