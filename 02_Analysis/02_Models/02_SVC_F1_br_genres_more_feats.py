...
Description:
    ...
    6. Saves the best results to a CSV file, including the combination of parameters that generates the best result.
...
Usage:
    ...
    3. Run the script: python 02_SVC_F1_br_genres_more_feats.py

Notes:
    - Adjust paths and filenames as needed.
    - Results are saved to 'svc_results_F1_br_genres_more_feats.csv' in the specified output directory.
"""
