...
Usage:
    ...
    3. Run the script: python 02_Random_Forest_F1_all_genres_more_feats.py

Notes:
    - Adjust paths and filenames as needed.
    - Results are saved to 'random_forest_results_F1_all_genres_more_feats.csv' in the specified output directory.
"""
...
df_results_RF = analysis_functions.exec_model(train_and_evaluate_rf, df, all_genres, feat_group_model, "Random Forest", False)

# Combine results and save to CSV
df_results_RF.to_csv(f'{folder_output}/random_forest_results_F1_all_genres_more_feats.csv', index=False)
logger.success(f"Results saved to '{folder_output}/random_forest_results_F1_all_genres_more_feats.csv'")
