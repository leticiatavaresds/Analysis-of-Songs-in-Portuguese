...
Usage:
    ...
    3. Run the script: python 02_Extra_Trees_F1_all_genres_more_feats.py

Notes:
    - Adjust paths and filenames as needed.
    - Results are saved to 'extra_trees_results_F1_all_genres_more_feats.csv' in the specified output directory.
"""
...
df_results_ET = analysis_functions.exec_model(train_and_evaluate_et, df, all_genres, feat_group_model, "Extra Trees", False)

# Combine results and save to CSV
df_results_ET.to_csv(f'{folder_output}/extra_trees_results_F1_all_genres_more_feats.csv', index=False)
logger.success(f"Results saved to '{folder_output}/extra_trees_results_F1_all_genres_more_feats.csv'")