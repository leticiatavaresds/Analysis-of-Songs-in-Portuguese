...
Usage:
    ...
    3. Run the script: python 02_Neural_Network_F1_all_genres.py

Notes:
    - Adjust paths and filenames as needed.
    - Results are saved to 'neural_network_results_F1_all_genres.csv' in the specified output directory.
"""
...
df_results_NN.to_csv(f'{folder_output}/neural_network_results_F1_all_genres.csv', index=False)
logger.success(f"Results saved to '{folder_output}/neural_network_results_F1_all_genres.csv'")
